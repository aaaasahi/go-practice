...
func main() {
	...
	fmt.Println(bt2, bt3, bt4, bt5, bt6) // 全てtrueに変換

	// falseへ変換できる文字列一覧
	// 二番目の戻り値はerror型なのでエラーハンドリングも可能
	...
	fmt.Println(bf2, bf3, bf4, bf5, bf6) // 全てfalse
	...
	fmt.Println(fl1, fl2, fl3, fl4, fl5) // 3.13 0.2...
}
